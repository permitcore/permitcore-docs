...
| Tier | Monthly requests | Cohorts | History | Webhooks |
|------|------------------|---------|---------|----------|
| Free | 1,000 | 6 (subset) | 30 days | — |
| Hobby ($49/mo) | 10,000 | All 18 | 90 days | 1 |
| Builder ($149/mo) | 100,000 | All 18 | Full | 5 |
| Growth ($299/mo) | 500,000 | All 18 | Full | 25 |
...

{
  "error": {
    "code": "rate_limited",
    "message": "Rate limit exceeded. Quota resets monthly.",
    "detail": {
...
- **Per-endpoint burst limits** (e.g., 30 req/sec sustained for permits
  endpoint)
- **Per-tier monthly request ceilings** (matrix above)
