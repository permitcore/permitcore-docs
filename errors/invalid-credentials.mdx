...
<Steps>
  ...
  <Step title="Rotate the key if it was revoked or lost">
    ...
    one at
    [permitcore.io/account/developers](https://permitcore.io/account/developers)
...
<Card title="Manage your keys" href="https://permitcore.io/account/developers" icon="key">
