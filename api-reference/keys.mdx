...
description: "Programmatic key creation, listing, revocation, + per-key usage telemetry. Coming with the Bucket 2 data-pipeline release (~3 weeks)."
---
...
- Sign up at <a href="https://permitcore.io/signup">permitcore.io/signup</a>
- Visit <a href="https://permitcore.io/account/api-keys">Account → API Keys</a>
  to view your active keys
- Email <a href="mailto:kian@permitcore.io">kian@permitcore.io</a> for
  key rotation or scope changes
