...
description: "Refreshed-nightly US building-permit data with field-level provenance and a canonical 23-segment taxonomy."
---

PermitCore is a building-permit data platform. The API ships **nightly-refreshed**
permits across **36 US metros** today,
